...
$sql = "SELECT ps.sale_id, c.name AS customer_name, c.email, c.phone_number, 
               p.part_type, p.compatibility, p.price, ps.sale_date, ps.payment_method 
        FROM Partsales ps
...
<div class="bill-container">
    ...
    <hr>
    <div class="details"><strong>Part Type:</strong> <?php echo $row['part_type'] . ' ' . $row['compatibility']; ?></div>
