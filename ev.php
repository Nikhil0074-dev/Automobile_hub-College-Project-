...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Get service price for the selected repair service
...
// Fetch only repair services
$services = $conn->query("SELECT service_id, service_name, price FROM Services WHERE service_type = 'ev'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Repair Services Booking</title>
  ...
  <div id="bookingform" class="form">
    <div class="form-content">
      ...
      <form method="POST" id="bookingForm" onsubmit="return validateBookingForm();">
        ...
        <!-- Hidden field to store service_id -->
